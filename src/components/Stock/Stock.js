      ...
      <div class="uk-grid-small" uk-grid="true">
        <div className="uk-width-1-1 uk-width-1-1@s uk-width-3-5@m">
          <div className="uk-card uk-card-default uk-card-body">
            ...
            <h2 class="uk-heading-divider uk-margin-remove-top">
              {data.companyName}
            </h2>
            <div className="uk-flex-inline uk-flex-wrap uk-width-1-1 uk-flex-between">
              <h1 className="uk-margin-remove">Closing</h1>
              <h1 className="uk-text-right uk-heading-primary uk-margin-remove">
                <sup>$</sup>
                {data.latestPrice}
                <h4 className={className(
                    "uk-text-right uk-margin-remove-top",
                    {
        ...
        <div className="uk-width-1-1 uk-width-1-1@s uk-width-1-2@m">
          <div class="uk-card uk-card-default uk-card-body">
            <h1 className="uk-heading-divider">Chart</h1>
          </div>
        </div>
        <div className="uk-width-1-1 uk-width-1-1@s uk-width-1-2@m">
          <div class="uk-card uk-card-default uk-card-body">
